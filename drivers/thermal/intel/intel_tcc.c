...
static const struct x86_cpu_id intel_tcc_cpu_ids[] __initconst = {
	X86_MATCH_VFM(INTEL_FAM6_CORE_YONAH,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_CORE2_MEROM,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_CORE2_MEROM_L,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_CORE2_PENRYN,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_CORE2_DUNNINGTON,	&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_NEHALEM,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_NEHALEM_G,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_NEHALEM_EP,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_NEHALEM_EX,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_WESTMERE,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_WESTMERE_EP,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_WESTMERE_EX,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_SANDYBRIDGE,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_SANDYBRIDGE_X,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_IVYBRIDGE,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_IVYBRIDGE_X,		&temp_haswell_x),
	X86_MATCH_VFM(INTEL_FAM6_HASWELL,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_HASWELL_X,		&temp_haswell_x),
	X86_MATCH_VFM(INTEL_FAM6_HASWELL_L,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_HASWELL_G,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_BROADWELL,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_BROADWELL_G,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_BROADWELL_X,		&temp_haswell_x),
	X86_MATCH_VFM(INTEL_FAM6_BROADWELL_D,		&temp_haswell_x),
	X86_MATCH_VFM(INTEL_FAM6_SKYLAKE_L,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_SKYLAKE,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_SKYLAKE_X,		&temp_haswell_x),
	X86_MATCH_VFM(INTEL_FAM6_KABYLAKE_L,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_KABYLAKE,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_COMETLAKE,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_COMETLAKE_L,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_CANNONLAKE_L,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ICELAKE_X,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ICELAKE_D,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ICELAKE,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ICELAKE_L,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ICELAKE_NNPI,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ROCKETLAKE,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_TIGERLAKE_L,		&temp_tigerlake),
	X86_MATCH_VFM(INTEL_FAM6_TIGERLAKE,		&temp_tigerlake),
	X86_MATCH_VFM(INTEL_FAM6_SAPPHIRERAPIDS_X,	&temp_sapphirerapids),
	X86_MATCH_VFM(INTEL_FAM6_EMERALDRAPIDS_X,	&temp_sapphirerapids),
	X86_MATCH_VFM(INTEL_FAM6_LAKEFIELD,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ALDERLAKE,		&temp_tigerlake),
	X86_MATCH_VFM(INTEL_FAM6_ALDERLAKE_L,		&temp_tigerlake),
	X86_MATCH_VFM(INTEL_FAM6_RAPTORLAKE,		&temp_tigerlake),
	X86_MATCH_VFM(INTEL_FAM6_RAPTORLAKE_P,		&temp_tigerlake),
	X86_MATCH_VFM(INTEL_FAM6_RAPTORLAKE_S,		&temp_tigerlake),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_BONNELL,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_BONNELL_MID,	&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_SALTWELL,		&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_SALTWELL_MID,	&temp_nehalem),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_SILVERMONT,	&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_SILVERMONT_D,	&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_SILVERMONT_MID,	&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_AIRMONT,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_AIRMONT_MID,	&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_AIRMONT_NP,	&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_GOLDMONT,		&temp_goldmont),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_GOLDMONT_D,	&temp_goldmont),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_GOLDMONT_PLUS,	&temp_goldmont),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_TREMONT_D,	&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_TREMONT,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_ATOM_TREMONT_L,	&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_XEON_PHI_KNL,		&temp_broadwell),
	X86_MATCH_VFM(INTEL_FAM6_XEON_PHI_KNM,		&temp_broadwell),
	{}
};
